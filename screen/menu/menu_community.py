...
from screen.function.mainscreen.function_communitybar import CommunityBar  # Import hàm từ file riêng

class MenuCommunityPage(QWidget):
    def __init__(self):
        super().__init__()
        self.initUI()
    ...
    def initUI(self):
        ...
        tabs_container = CommunityBar(self, font_family)
